<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">Centros de Costo</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                <div class="text-left col-sm-12 align-self-center">
                                    <h3 class="card-title">Listado de los centros de costo registrados en la plataforma.</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <table id="centros" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>#</th>
...
<script src="{$settings['url']}/assets/ajax/centros.js?v={$v}"></script>