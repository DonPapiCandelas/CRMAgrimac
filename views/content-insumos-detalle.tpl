            ...
            <div class="row">
                <div class="col-sm-10">
                    <h1 class="m-0 text-dark" style="font-size: 1.8rem; font-weight: 500;">
                        Detalle de la Salida de Insumo #{$values->id}
                    </h1>
                </div>
                <div class="col-sm-2">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row mt-5 mb-3">
                            <div class="col-sm-12 table-responsive">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <p class="lead">Comentarios del documento:</p>
                                    </div>
...
<div class="modal fade" id="modal-addNote">
        ...
        <div class="modal-content">
            <form action="" id="form-addNote" method="post">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white">Agregar comentario al documento</h5>
    ...
    <script src="{$settings['url']}/assets/ajax/insumos-detalle.js?v={$v}"></script>
</body>
</html>