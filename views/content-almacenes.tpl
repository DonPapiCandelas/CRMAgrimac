            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                <div class="text-left col-sm-12 align-self-center">
                                    <h3 class="card-title">Listado de los almacenes registrados en la plataforma.</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <table id="almacenes" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th style="width: 5%;">#</th>
                                        <th>Almacen</th>
...
<script src="{$settings['url']}/assets/ajax/almacenes.js?v={$v}"></script>