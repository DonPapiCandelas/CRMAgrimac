                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="text-left col-sm-10 align-self-center">
                                    <h3 class="card-title">Listado de las requisiciones pendientes de autorizar.</h3>
                                </div>
...
<script src="{$settings['url']}/assets/ajax/requisiciones-autorizador.js?v={$v}"></script>