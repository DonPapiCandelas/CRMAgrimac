...
class SQLDatabase implements DatabaseInterface
{
    ...
    /**
     * @var mixed Database variables
     */
    protected $server = 'localhost';
    protected $instance = 'comercial';
    protected $user = 'sa';
    protected $password = 'Admin1';
    protected $database = 'GRUPO_AGRIMAC_2021';
    ...
    public function __construct()
    {
        ...
        try {
            $this->pdo = new MyPDO("sqlsrv:Server=$servername; Database=" . $this->database, $this->user, $this->password);
