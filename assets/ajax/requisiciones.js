...
$(document).ready(function() {
    ...
    $('#requisiciones').on('click', 'button.delrow', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            preConfirm: (password) => {
                return fetch(getURL() + 'requisiciones/eliminar-requisicion/'+ data.uniqid +'/' + password)
...
function listar() {
    $.post(getURL() + 'requisiciones/listar', null, null, 'JSON')
